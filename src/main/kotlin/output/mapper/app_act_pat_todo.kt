...
@Delete("DELETE FROM app_act_pat_todo WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE app_act_pat_todo SET
        ID=#{ID,jdbcType=String},
        TODONAME=#{TODONAME,jdbcType=String},
        TESTCASEID=#{TESTCASEID,jdbcType=String},
        BATCHPLANID=#{BATCHPLANID,jdbcType=String},
        PLANID=#{PLANID,jdbcType=String},
        PLANPATHID=#{PLANPATHID,jdbcType=String},
...
fun UpdateByPrimaryKey(model:app_act_pat_todo_dto)
        

@Update("""<script>
            UPDATE app_act_pat_todo SET
            <if test="ID != null">  ID=#{ID,jdbcType=String},</if>
        <if test="TODONAME != null">  TODONAME=#{TODONAME,jdbcType=String},</if>
        ...
        <if test="PLANPATHID != null">  PLANPATHID=#{PLANPATHID,jdbcType=String},</if>
...
fun UpdateByPrimaryKeySelective(model:app_act_pat_todo_dto)
