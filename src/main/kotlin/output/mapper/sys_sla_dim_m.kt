...
fun InsertSelective(model:sys_sla_dim_m_dto):Unit
                


@Delete("DELETE FROM sys_sla_dim_m WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE sys_sla_dim_m SET
...
fun UpdateByPrimaryKey(model:sys_sla_dim_m_dto)
...
fun UpdateByPrimaryKeySelective(model:sys_sla_dim_m_dto)
