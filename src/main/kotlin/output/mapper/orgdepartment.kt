...
@Delete("DELETE FROM orgdepartment WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE orgdepartment SET
...
fun UpdateByPrimaryKey(model:orgdepartment_dto)
...
fun UpdateByPrimaryKeySelective(model:orgdepartment_dto)
