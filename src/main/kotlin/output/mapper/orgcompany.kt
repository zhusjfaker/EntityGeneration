...
@Delete("DELETE FROM orgcompany WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE orgcompany SET
        ID=#{ID,jdbcType=String},
        COMPANYNO=#{COMPANYNO,jdbcType=String},
        ...
        COMPANYTYPE=#{COMPANYTYPE,jdbcType=String},
        COMPANYDESC=#{COMPANYDESC,jdbcType=String},
...
fun UpdateByPrimaryKey(model:orgcompany_dto)
        

@Update("""<script>
            UPDATE orgcompany SET
            <if test="ID != null">  ID=#{ID,jdbcType=String},</if>
        <if test="COMPANYNO != null">  COMPANYNO=#{COMPANYNO,jdbcType=String},</if>
        ...
        <if test="COMPANYTYPE != null">  COMPANYTYPE=#{COMPANYTYPE,jdbcType=String},</if>
        <if test="COMPANYDESC != null">  COMPANYDESC=#{COMPANYDESC,jdbcType=String},</if>
...
fun UpdateByPrimaryKeySelective(model:orgcompany_dto)
