...
@Delete("DELETE FROM bo_act_cms_content WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE bo_act_cms_content SET
        ...
        CANCHOOSEFLAG=#{CANCHOOSEFLAG,jdbcType=String}
        WHERE ID=#{ID,jdbcType=String}
        </script>""")
fun UpdateByPrimaryKey(model:bo_act_cms_content_dto)
...
@Update("""<script>
        ...
        <if test="CANCHOOSEFLAG != null">  CANCHOOSEFLAG=#{CANCHOOSEFLAG,jdbcType=String}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:bo_act_cms_content_dto)
