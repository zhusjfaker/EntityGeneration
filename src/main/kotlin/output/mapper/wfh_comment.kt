...
@Delete("DELETE FROM wfh_comment WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE wfh_comment SET
...
fun UpdateByPrimaryKey(model:wfh_comment_dto)
...
@Update("""<script>
        ...
        <if test="MSG != null">  MSG=#{MSG,jdbcType=String}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:wfh_comment_dto)
