...
fun ConditionalQuery(model:bo_act_org_ext_team_dto):ArrayList<bo_act_org_ext_team_dto>
...
fun ConditionalQueryByKey(model:bo_act_org_ext_team_dto):bo_act_org_ext_team_dto?
                


@Insert("""<script>
    insert into bo_act_org_ext_team
    (ID,ORGID,BINDID,CREATEDATE,CREATEUSER,UPDATEDATE,UPDATEUSER,PROCESSDEFID,ISEND,TEAMID)
    values
    (#{ID},#{ORGID},#{BINDID},#{CREATEDATE},#{CREATEUSER},#{UPDATEDATE},#{UPDATEUSER},#{PROCESSDEFID},#{ISEND},#{TEAMID})
</script>""")
fun Insert(model:bo_act_org_ext_team_dto):Unit
...
fun InsertSelective(model:bo_act_org_ext_team_dto):Unit
                


@Delete("DELETE FROM bo_act_org_ext_team WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE bo_act_org_ext_team SET
...
fun UpdateByPrimaryKey(model:bo_act_org_ext_team_dto)
...
fun UpdateByPrimaryKeySelective(model:bo_act_org_ext_team_dto)
