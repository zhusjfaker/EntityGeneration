...
@Delete("DELETE FROM bo_ss_payitem WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE bo_ss_payitem SET
...
fun UpdateByPrimaryKey(model:bo_ss_payitem_dto)
...
fun UpdateByPrimaryKeySelective(model:bo_ss_payitem_dto)
