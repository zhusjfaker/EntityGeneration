...
fun ConditionalQuery(model:bo_act_org_ext_user_dto):ArrayList<bo_act_org_ext_user_dto>
...
fun ConditionalQueryByKey(model:bo_act_org_ext_user_dto):bo_act_org_ext_user_dto?
                


@Insert("""<script>
    insert into bo_act_org_ext_user
    (ID,ORGID,BINDID,CREATEDATE,CREATEUSER,UPDATEDATE,UPDATEUSER,PROCESSDEFID,ISEND,USERID)
    values
    (#{ID},#{ORGID},#{BINDID},#{CREATEDATE},#{CREATEUSER},#{UPDATEDATE},#{UPDATEUSER},#{PROCESSDEFID},#{ISEND},#{USERID})
</script>""")
fun Insert(model:bo_act_org_ext_user_dto):Unit
...
fun InsertSelective(model:bo_act_org_ext_user_dto):Unit
                


@Delete("DELETE FROM bo_act_org_ext_user WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE bo_act_org_ext_user SET
...
fun UpdateByPrimaryKey(model:bo_act_org_ext_user_dto)
...
@Update("""<script>
        ...
        <if test="USERID != null">  USERID=#{USERID,jdbcType=String}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:bo_act_org_ext_user_dto)
