...
@Delete("DELETE FROM sys_coe_pal_shape_attribute WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE sys_coe_pal_shape_attribute SET
        ID=#{ID,jdbcType=String},
        WSID=#{WSID,jdbcType=String},
        ATTRID=#{ATTRID,jdbcType=String},
        ATTRNAME=#{ATTRNAME,jdbcType=String},
        ATTRVALUE=#{ATTRVALUE,jdbcType=String},
        CATEGORY=#{CATEGORY,jdbcType=String},
        METHODID=#{METHODID,jdbcType=String},
        TYPE=#{TYPE,jdbcType=String},
        SHAPENAME=#{SHAPENAME,jdbcType=String}
        WHERE ID=#{ID,jdbcType=String}
        </script>""")
fun UpdateByPrimaryKey(model:sys_coe_pal_shape_attribute_dto)
...
@Update("""<script>
        ...
        <if test="ATTRNAME != null">  ATTRNAME=#{ATTRNAME,jdbcType=String},</if>
        <if test="ATTRVALUE != null">  ATTRVALUE=#{ATTRVALUE,jdbcType=String},</if>
        <if test="CATEGORY != null">  CATEGORY=#{CATEGORY,jdbcType=String},</if>
        <if test="METHODID != null">  METHODID=#{METHODID,jdbcType=String},</if>
        <if test="TYPE != null">  TYPE=#{TYPE,jdbcType=String},</if>
        <if test="SHAPENAME != null">  SHAPENAME=#{SHAPENAME,jdbcType=String}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:sys_coe_pal_shape_attribute_dto)
