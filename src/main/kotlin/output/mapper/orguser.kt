...
fun InsertSelective(model:orguser_dto):Unit
                


@Delete("DELETE FROM orguser WHERE ID=#{arg0}")
...
fun UpdateByPrimaryKey(model:orguser_dto)
...
fun UpdateByPrimaryKeySelective(model:orguser_dto)
