...
@Delete("DELETE FROM app_act_mportal_nav WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE app_act_mportal_nav SET
...
fun UpdateByPrimaryKey(model:app_act_mportal_nav_dto)
...
@Update("""<script>
        ...
        <if test="ORDERNO != null">  ORDERNO=#{ORDERNO,jdbcType=Integer},</if>
...
fun UpdateByPrimaryKeySelective(model:app_act_mportal_nav_dto)
