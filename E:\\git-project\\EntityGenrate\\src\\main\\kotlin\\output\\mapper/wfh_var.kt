...
fun ConditionalQuery(model:wfh_var_dto):ArrayList<wfh_var_dto>
...
fun ConditionalQueryByKey(model:wfh_var_dto):wfh_var_dto?
...
@Delete("DELETE FROM wfh_var WHERE ID=#{arg0}")
...
fun UpdateByPrimaryKey(model:wfh_var_dto)
...
fun UpdateByPrimaryKeySelective(model:wfh_var_dto)
