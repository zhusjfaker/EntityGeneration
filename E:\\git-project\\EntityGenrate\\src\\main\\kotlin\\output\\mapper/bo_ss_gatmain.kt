...
@Delete("DELETE FROM bo_ss_gatmain WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE bo_ss_gatmain SET
...
fun UpdateByPrimaryKey(model:bo_ss_gatmain_dto)
...
fun UpdateByPrimaryKeySelective(model:bo_ss_gatmain_dto)
