...
interface sys_coe_pal_repository_r{
...
@Select("""<script>
   SELECT * FROM sys_coe_pal_repository_r
</script>""")
fun GetListAll():ArrayList<sys_coe_pal_repository_r_dto>
...
fun ConditionalQuery(model:sys_coe_pal_repository_r_dto):ArrayList<sys_coe_pal_repository_r_dto>
...
fun InsertSelective(model:sys_coe_pal_repository_r_dto):Unit
                


@Delete("DELETE FROM sys_coe_pal_repository_r WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE sys_coe_pal_repository_r SET
        ID=#{ID,jdbcType=String},
        REMOVEID=#{REMOVEID,jdbcType=String},
...
fun UpdateByPrimaryKey(model:sys_coe_pal_repository_r_dto)
        

@Update("""<script>
            UPDATE sys_coe_pal_repository_r SET
            <if test="ID != null">  ID=#{ID,jdbcType=String},</if>
        <if test="REMOVEID != null">  REMOVEID=#{REMOVEID,jdbcType=String},</if>
...
fun UpdateByPrimaryKeySelective(model:sys_coe_pal_repository_r_dto)
