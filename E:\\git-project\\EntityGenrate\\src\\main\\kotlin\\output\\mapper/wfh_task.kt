...
@Delete("DELETE FROM wfh_task WHERE ID=#{arg0}")
...
@Update("""<script>
        ...
        ENDENGINENODE=#{ENDENGINENODE,jdbcType=String},
        ...
        ISUNDO=#{ISUNDO,jdbcType=Integer},
...
fun UpdateByPrimaryKey(model:wfh_task_dto)
...
@Update("""<script>
        ...
        <if test="ENDENGINENODE != null">  ENDENGINENODE=#{ENDENGINENODE,jdbcType=String},</if>
        ...
        <if test="ISUNDO != null">  ISUNDO=#{ISUNDO,jdbcType=Integer},</if>
...
fun UpdateByPrimaryKeySelective(model:wfh_task_dto)
