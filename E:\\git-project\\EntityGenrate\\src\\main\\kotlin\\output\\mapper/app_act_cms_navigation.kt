...
@Delete("DELETE FROM app_act_cms_navigation WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE app_act_cms_navigation SET
        ID=#{ID,jdbcType=String},
        NAVSITEOWNERID=#{NAVSITEOWNERID,jdbcType=String},
        NAVNAME=#{NAVNAME,jdbcType=String},
        SITEID=#{SITEID,jdbcType=String},
        NAVURL=#{NAVURL,jdbcType=String},
        CREATETIME=#{CREATETIME,jdbcType=Timestamp},
        CREATEUSER=#{CREATEUSER,jdbcType=String},
        LINKTARGET=#{LINKTARGET,jdbcType=String}
        WHERE ID=#{ID,jdbcType=String}
        </script>""")
fun UpdateByPrimaryKey(model:app_act_cms_navigation_dto)
        

@Update("""<script>
            UPDATE app_act_cms_navigation SET
            <if test="ID != null">  ID=#{ID,jdbcType=String},</if>
        <if test="NAVSITEOWNERID != null">  NAVSITEOWNERID=#{NAVSITEOWNERID,jdbcType=String},</if>
        <if test="NAVNAME != null">  NAVNAME=#{NAVNAME,jdbcType=String},</if>
        <if test="SITEID != null">  SITEID=#{SITEID,jdbcType=String},</if>
        <if test="NAVURL != null">  NAVURL=#{NAVURL,jdbcType=String},</if>
        <if test="CREATETIME != null">  CREATETIME=#{CREATETIME,jdbcType=Timestamp},</if>
        <if test="CREATEUSER != null">  CREATEUSER=#{CREATEUSER,jdbcType=String},</if>
        <if test="LINKTARGET != null">  LINKTARGET=#{LINKTARGET,jdbcType=String}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:app_act_cms_navigation_dto)
