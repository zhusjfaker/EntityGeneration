...
@Delete("DELETE FROM sys_audit_log WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE sys_audit_log SET
        ID=#{ID,jdbcType=String},
        LOG_CHANNEL=#{LOG_CHANNEL,jdbcType=String},
        LOG_CATALOG=#{LOG_CATALOG,jdbcType=String},
        LOG_OBJECT=#{LOG_OBJECT,jdbcType=String},
        OP=#{OP,jdbcType=String},
        OP_TIME=#{OP_TIME,jdbcType=Timestamp},
        OP_IP=#{OP_IP,jdbcType=String},
        OP_INFO=#{OP_INFO,jdbcType=String},
        OP_LEVEL=#{OP_LEVEL,jdbcType=Integer},
        AUDIT_ROLE=#{AUDIT_ROLE,jdbcType=Integer},
        OP_USER=#{OP_USER,jdbcType=String},
        EXT1=#{EXT1,jdbcType=String}
        WHERE ID=#{ID,jdbcType=String}
        </script>""")
fun UpdateByPrimaryKey(model:sys_audit_log_dto)
        

@Update("""<script>
            UPDATE sys_audit_log SET
            <if test="ID != null">  ID=#{ID,jdbcType=String},</if>
        <if test="LOG_CHANNEL != null">  LOG_CHANNEL=#{LOG_CHANNEL,jdbcType=String},</if>
        <if test="LOG_CATALOG != null">  LOG_CATALOG=#{LOG_CATALOG,jdbcType=String},</if>
        <if test="LOG_OBJECT != null">  LOG_OBJECT=#{LOG_OBJECT,jdbcType=String},</if>
        <if test="OP != null">  OP=#{OP,jdbcType=String},</if>
        <if test="OP_TIME != null">  OP_TIME=#{OP_TIME,jdbcType=Timestamp},</if>
        <if test="OP_IP != null">  OP_IP=#{OP_IP,jdbcType=String},</if>
        <if test="OP_INFO != null">  OP_INFO=#{OP_INFO,jdbcType=String},</if>
        <if test="OP_LEVEL != null">  OP_LEVEL=#{OP_LEVEL,jdbcType=Integer},</if>
        <if test="AUDIT_ROLE != null">  AUDIT_ROLE=#{AUDIT_ROLE,jdbcType=Integer},</if>
        <if test="OP_USER != null">  OP_USER=#{OP_USER,jdbcType=String},</if>
        <if test="EXT1 != null">  EXT1=#{EXT1,jdbcType=String}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:sys_audit_log_dto)
