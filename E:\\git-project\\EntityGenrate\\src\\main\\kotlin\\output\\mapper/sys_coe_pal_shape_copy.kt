...
@Delete("DELETE FROM sys_coe_pal_shape_copy WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE sys_coe_pal_shape_copy SET
...
fun UpdateByPrimaryKey(model:sys_coe_pal_shape_copy_dto)
...
fun UpdateByPrimaryKeySelective(model:sys_coe_pal_shape_copy_dto)
