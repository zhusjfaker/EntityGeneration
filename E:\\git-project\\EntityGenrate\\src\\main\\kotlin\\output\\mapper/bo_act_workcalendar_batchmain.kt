...
@Delete("DELETE FROM bo_act_workcalendar_batchmain WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE bo_act_workcalendar_batchmain SET
        ...
        YEAR=#{YEAR,jdbcType=String}
        WHERE ID=#{ID,jdbcType=String}
        </script>""")
fun UpdateByPrimaryKey(model:bo_act_workcalendar_batchmain_dto)
...
@Update("""<script>
        ...
        <if test="YEAR != null">  YEAR=#{YEAR,jdbcType=String}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:bo_act_workcalendar_batchmain_dto)
