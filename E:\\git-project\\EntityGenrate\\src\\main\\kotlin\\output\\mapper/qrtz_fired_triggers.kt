...
@Delete("DELETE FROM qrtz_fired_triggers WHERE SCHED_NAME=#{arg0}")
...
@Update("""<script>
        ...
        ENTRY_ID=#{ENTRY_ID,jdbcType=String},
        TRIGGER_NAME=#{TRIGGER_NAME,jdbcType=String},
        TRIGGER_GROUP=#{TRIGGER_GROUP,jdbcType=String},
        INSTANCE_NAME=#{INSTANCE_NAME,jdbcType=String},
        FIRED_TIME=#{FIRED_TIME,jdbcType=Long},
        SCHED_TIME=#{SCHED_TIME,jdbcType=Long},
...
fun UpdateByPrimaryKey(model:qrtz_fired_triggers_dto)
        

@Update("""<script>
            UPDATE qrtz_fired_triggers SET
            <if test="SCHED_NAME != null">  SCHED_NAME=#{SCHED_NAME,jdbcType=String},</if>
        <if test="ENTRY_ID != null">  ENTRY_ID=#{ENTRY_ID,jdbcType=String},</if>
        ...
        <if test="INSTANCE_NAME != null">  INSTANCE_NAME=#{INSTANCE_NAME,jdbcType=String},</if>
        <if test="FIRED_TIME != null">  FIRED_TIME=#{FIRED_TIME,jdbcType=Long},</if>
        <if test="SCHED_TIME != null">  SCHED_TIME=#{SCHED_TIME,jdbcType=Long},</if>
        <if test="PRIORITY != null">  PRIORITY=#{PRIORITY,jdbcType=Integer},</if>
        <if test="STATE != null">  STATE=#{STATE,jdbcType=String},</if>
        ...
        <if test="REQUESTS_RECOVERY != null">  REQUESTS_RECOVERY=#{REQUESTS_RECOVERY,jdbcType=String}
              WHERE SCHED_NAME=#{SCHED_NAME,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:qrtz_fired_triggers_dto)
