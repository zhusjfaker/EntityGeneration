...
@Delete("DELETE FROM app_act_email_templete WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE app_act_email_templete SET
        ID=#{ID,jdbcType=String},
        TEMPLATENAME=#{TEMPLATENAME,jdbcType=String},
        EMAILTO=#{EMAILTO,jdbcType=String},
        COPYTO=#{COPYTO,jdbcType=String},
        EMAIL_TITLE=#{EMAIL_TITLE,jdbcType=String},
        EMAIL_CONTENT=#{EMAIL_CONTENT,jdbcType=String},
        TEMPLATETYPE=#{TEMPLATETYPE,jdbcType=String},
        ISDEFAULT=#{ISDEFAULT,jdbcType=Integer},
        EMAILFROM=#{EMAILFROM,jdbcType=String},
        FROMNAME=#{FROMNAME,jdbcType=String},
        ISVALID=#{ISVALID,jdbcType=Integer}
        WHERE ID=#{ID,jdbcType=String}
        </script>""")
fun UpdateByPrimaryKey(model:app_act_email_templete_dto)
...
@Update("""<script>
        ...
        <if test="EMAILTO != null">  EMAILTO=#{EMAILTO,jdbcType=String},</if>
        <if test="COPYTO != null">  COPYTO=#{COPYTO,jdbcType=String},</if>
        <if test="EMAIL_TITLE != null">  EMAIL_TITLE=#{EMAIL_TITLE,jdbcType=String},</if>
        <if test="EMAIL_CONTENT != null">  EMAIL_CONTENT=#{EMAIL_CONTENT,jdbcType=String},</if>
        <if test="TEMPLATETYPE != null">  TEMPLATETYPE=#{TEMPLATETYPE,jdbcType=String},</if>
        <if test="ISDEFAULT != null">  ISDEFAULT=#{ISDEFAULT,jdbcType=Integer},</if>
        <if test="EMAILFROM != null">  EMAILFROM=#{EMAILFROM,jdbcType=String},</if>
        <if test="FROMNAME != null">  FROMNAME=#{FROMNAME,jdbcType=String},</if>
        <if test="ISVALID != null">  ISVALID=#{ISVALID,jdbcType=Integer}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:app_act_email_templete_dto)
