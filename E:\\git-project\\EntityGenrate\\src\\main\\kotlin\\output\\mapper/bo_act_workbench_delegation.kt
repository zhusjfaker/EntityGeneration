...
@Delete("DELETE FROM bo_act_workbench_delegation WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE bo_act_workbench_delegation SET
        ...
        USERCOMPANY=#{USERCOMPANY,jdbcType=String},
...
fun UpdateByPrimaryKey(model:bo_act_workbench_delegation_dto)
...
@Update("""<script>
        ...
        <if test="USERCOMPANY != null">  USERCOMPANY=#{USERCOMPANY,jdbcType=String},</if>
        ...
        <if test="DELEGATEREASON != null">  DELEGATEREASON=#{DELEGATEREASON,jdbcType=String}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:bo_act_workbench_delegation_dto)
