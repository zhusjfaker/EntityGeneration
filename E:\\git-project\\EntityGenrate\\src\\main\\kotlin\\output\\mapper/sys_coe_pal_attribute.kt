...
@Delete("DELETE FROM sys_coe_pal_attribute WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE sys_coe_pal_attribute SET
...
fun UpdateByPrimaryKey(model:sys_coe_pal_attribute_dto)
...
@Update("""<script>
        ...
        <if test="ISDELETE != null">  ISDELETE=#{ISDELETE,jdbcType=String}
              WHERE ID=#{ID,jdbcType=String}
            </script>""")
fun UpdateByPrimaryKeySelective(model:sys_coe_pal_attribute_dto)
