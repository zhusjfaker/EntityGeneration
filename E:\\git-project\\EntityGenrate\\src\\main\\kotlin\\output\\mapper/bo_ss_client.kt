...
@Delete("DELETE FROM bo_ss_client WHERE ID=#{arg0}")
fun DeleteByPrimaryKey(ID:String)
        

@Update("""<script>
        UPDATE bo_ss_client SET
        ...
        CCODE=#{CCODE,jdbcType=String},
        CNAME=#{CNAME,jdbcType=String},
...
fun UpdateByPrimaryKey(model:bo_ss_client_dto)
...
@Update("""<script>
        ...
        <if test="CCODE != null">  CCODE=#{CCODE,jdbcType=String},</if>
        <if test="CNAME != null">  CNAME=#{CNAME,jdbcType=String},</if>
...
fun UpdateByPrimaryKeySelective(model:bo_ss_client_dto)
